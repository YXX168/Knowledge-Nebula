...
LABEL org.opencontainers.image.title="Knowledge Nebula" \
      org.opencontainers.image.description="Local-first knowledge base browser with search, previews, secure editing and live sync" \
